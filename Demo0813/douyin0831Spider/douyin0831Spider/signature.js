...
function search_item(keyword,offset,count){
        var e={"url":"/aweme/v1/web/search/item/","method":"get","headers":{"Accept":"application/json, text/plain, */*","Content-Type":"application/json","withCredentials":true},"params":{"device_platform":"webapp","aid":6383,"channel":"channel_pc_web","search_channel":"aweme_video_web","sort_type":"0","publish_time":"0","keyword":keyword,"search_source":"normal_search","query_correct_type":"1","is_filter_search":"0","offset":offset,"count":count,"version_code":"160100","version_name":"16.1.0","cookie_enabled":true,"screen_width":1280,"screen_height":720,"browser_language":"zh-CN","browser_platform":"Win32","browser_name":"Mozilla","browser_version":"5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.164 Safari/537.36","browser_online":true},"baseURL":"","transformRequest":[null],"transformResponse":[null],"timeout":0,"xsrfCookieName":"XSRF-TOKEN","xsrfHeaderName":"X-XSRF-TOKEN","maxContentLength":-1,"maxBodyLength":-1};
        var f = e.data
          , d = e.headers;
        r.isFormData(f) && delete d["Content-Type"];
        var h = new XMLHttpRequest;
...
function cooment(aweme_id,cursor,count){
        var e={
            ...
            "params":{
                ...
                "browser_version":"5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F92.0.4515.107+Safari%2F537.36",
                "browser_online":true
            },
